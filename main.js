    ...
    if (opt.options === "FAST CASH") {
        ...
        if (amount.amountwithdraw <= mybalance) {
            ...
            console.log(chalk.magentaBright
                .bold `AMOUNT SECCESSFULY WITHDRAWN NOW YOUR CURRENT BALANCE IS: ${mybalance}`);
        }
        else {
            console.log(chalk.redBright
                .italic `INSUFFICIENT BALANCE YOUR BALANCE IS:${mybalance}`);
        }
    }
        ...
        console.log(`AMOUNT SUCCESSFULLY DEPOSITED YOUR CURRENT BALANCE IS:${mybalance}`);
    }
}
else {
